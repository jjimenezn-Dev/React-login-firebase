                    ...
                    <Row>
                        <Col md={6}>
                            <Row>
                                ...
                                <Col className="fit" md={12}>
                                    <div className="panel">
                                        <ReactPlayer url='https://youtu.be/O4iitaMmPkI' />
                                    </div>
                                </Col>
                            </Row>
                            <Row>
                                ...
                                <Col className="fit" md={12}>
                                    <div className="panel">
                                        <ReactPlayer url='https://youtu.be/64Qv10EVbJ8' />
                                    </div>
                                </Col>
                            </Row>
                            <Row>
                                ...
                                <Col className="fit" md={12}>
                                    <div className="panel">
                                        <ReactPlayer url='https://youtu.be/uEX0tWpM224' />
                                    </div>
                                </Col>
                            </Row>
                        </Col>
                        <Col md={6}>
                            <Row>
                                ...
                                <Col className="fit" md={12}>
                                    <div className="panel">
                                        <ReactPlayer url='https://youtu.be/ostnjsLjPso' />
                                    </div>
                                </Col>
                            </Row>
                            <Row>
